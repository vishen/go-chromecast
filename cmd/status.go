...
var statusCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if castApplication == nil {
			...
			outputInfo("%s%s (%s:%d), %s, time remaining=%.0fs/%.0fs, volume=%0.2f, muted=%t\n", usefulID, castApplication.DisplayName, castMedia.PlayerState, castMedia.CustomData.PlayerState, metadata, castMedia.CurrentTime, castMedia.Media.Duration, castVolume.Level, castVolume.Muted)
		}
	},
}
